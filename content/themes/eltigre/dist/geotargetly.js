...
var DEFAULT_COUNTRY_LANGUAGE = "en-eu";
...
window.geotargetly_loaded = function () {
  ...
  var userCountryLanguage = "".concat(data.language, "-").concat(data.countryCode).toLowerCase();
  ...
  if (language) {
    var _userCountryLanguage$ = userCountryLanguage.split('-'),
        _userCountryLanguage$2 = _slicedToArray(_userCountryLanguage$, 2),
        userLanguage = _userCountryLanguage$2[0],
        userCountry = _userCountryLanguage$2[1];

    (0,_utils_functions__WEBPACK_IMPORTED_MODULE_0__.setLanguageCookies)(userLanguage, userCountry);
    var redirectURL = language === null || language === void 0 ? void 0 : language.url;
    ...
    if (redirectURL) {
      ...
      window.location.href = "".concat(redirectURL).concat(separator, "language-redirect=true");
    }
  }
};
}();
