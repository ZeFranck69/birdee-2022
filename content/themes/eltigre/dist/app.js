...
var Section = /*#__PURE__*/function () {
  ...
  _createClass(Section, [{
    ...
    value: function animate() {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("c3cf7d0_0", 'ici')));
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function keepUtmParams() {
      var utmParams = {
        source: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_5__.getQueryParam)('utm_source'),
        medium: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_5__.getQueryParam)('utm_medium'),
        campaign: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_5__.getQueryParam)('utm_campaign')
