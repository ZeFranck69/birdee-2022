...
var Intercom = /*#__PURE__*/_createClass(function Intercom() {
  ...
  (_console = console).log.apply(_console, _toConsumableArray(oo_oo("539731593_6_2_6_47_4", "c'est l'ID de intercom " + site)));
  /* eslint-disable */


  (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("539731593_7_2_7_59_4", "c'est l'ID de intercom2 " + site.intercom_id)));
  /* eslint-disable */


  (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("539731593_7_2_7_59_4", "c'est l'ID de intercom3 " + APP_ID)));
